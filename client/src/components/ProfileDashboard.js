...
const ProfileDashboard = (props) => {
  ...
  return (
    <Fragment>
      ...
      ) : props.profile.loading === false && props.profile.profile === null ? (
        <NotFound />
      ) : (
        <Fragment>
          <Link to="/profiles" className="btn btn-3">
            Back
          </Link>
          {props.auth.isAuthenticated &&
            !props.auth.loading &&
            props.auth.user._id === props.profile.profile.user._id && (
              <Link to="/edit-profile" className="btn btn-3">
                {" "}
                Edit Your Profile
              </Link>
            )}
          ...
          <div className="about-container">
            ...
            <h2 className="text-primary Acenter">
              {" "}
              {props.profile.profile.user.name}'s Bio
            </h2>
            <p className="Acenter redColor" style={{ marginBottom: "50px" }}>
              {props.profile.profile.bio}{" "}
            </p>

            <h2 className="text-primary Acenter">
              {" "}
              {props.profile.profile.user.name}'s Skills
            </h2>
          ...
          <div
            ...
            style={{ margin: "20px auto", lineHeight: "35px" }}
          >
            <h2 className="redColor" style={{ marginBottom: "20px" }}>
              Experience
            </h2>
