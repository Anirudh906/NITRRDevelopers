...
const EditProfile = (props) => {
  ...
  useEffect(() => {
    ...
    setFormData({
      branch:
        props.profile.loading || !props.profile.profile.branch
          ? ""
          : props.profile.profile.branch,
      website:
      ...
      CodeforcesHandle:
        props.profile.loading || !props.profile.profile.CodeforcesHandle
          ? ""
          : props.profile.profile.CodeforcesHandle,
      CodechefHandle:
        props.profile.loading || !props.profile.profile.CodechefHandle
          ? ""
          : props.profile.profile.CodechefHandle,
      LeetcodeHandle:
        props.profile.loading || !props.profile.profile.LeetcodeHandle
          ? ""
          : props.profile.profile.LeetcodeHandle,
      bio:
...
export default connect(map, { createProfile, currentProfile })(
